...
PLOTwithLeg(T,t, legAngle, figuretitle,'Virtual leg pitch angle [rad]');
...
% PLOTwithLeg(T,t, legAngularVelocity, 'Virtual Leg Pitch Angular Velocity','Virtual leg pitch angular velocity [rad/s]');
...
% PLOTwithLeg(T,t, legAngularAcceleration, 'Virtual Leg Pitch Angular Acceleration','Virtual leg pitch angular acceleration [rad/s^2]');
